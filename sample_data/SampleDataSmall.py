...
class SampleDataSmall:
	def __init__(self):
		self.test_info = {'test_name': 'SmallMoistureCell',
						  'sample_dir': 'C:\\Users\\karlisr\\OneDrive - NTNU\\3_PostDoc_Sintef\\'
										'01_laboratory_work\\02_small_test\\01_measured_samples'}
		...
		self.plot_folders = [self.folders['01_time_series_plots'],
							 self.folders['02_temperature_gradient_plots'],
							 self.folders['03_animated_plots']]
		...
		self.SS1 = {
			...
			'temperature_columns': ['top', 'T1', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'bot', 'ext'],
			'phase_names': ['5.3W_hot_end'],
			'hot_end_sensors': {
				'sensors': ['top'],
				'locations': [0.1],
			},
			...
			'comsol_files': [],
			'sample_props': {
				'porosity': 0.4,  # this is dummy data
		...
		self.SS2 = {'sample_name': 'SS2',
					'columns': ['top', 'T1', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'bot', 'ext', 'power'],
					'temperature_columns': [
						'top', 'T1', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'bot', 'ext'],
					'phase_names': ['4.0W_hot_end'],
