	...
	def __init__(self):
		...
		self.SN2 = {'sample_name': 'SN2',
					...
					'phases': [{'start': pd.Timestamp(2021, 1, 14, 9, 56), 'end': pd.Timestamp(2021, 1, 19, 14, 33),
								...
								{'start': pd.Timestamp(2021, 2, 1, 10, 30), 'end': pd.Timestamp(2021, 2, 6, 9, 17),
								 'name': '217W_core'},
								{'start': pd.Timestamp(2021, 2, 6, 9, 18), 'end': pd.Timestamp(2021, 2, 16, 10, 39),
								 'name': '290W_core'}],
					'core_sensors': {'sensors': ['X1', 'X2'],
									 'locations': [0, 26]},
		...
		self.SN3 = {'sample_name': 'SN3',
					...
					'moisture_columns': ['MS1', 'MS2', 'MS3', 'MS4', 'MS5', 'MS6',
										 'MS7', 'MS8', 'MS9', 'MS10', 'MS11', 'MS12'],
					'power_column': ['power'],
					'timestamps': [[pd.Timestamp(2021, 5, 13, 8, 0), '170W core']],
					'phases': [{'start': pd.Timestamp(2021, 5, 2, 17, 43), 'end': pd.Timestamp(2021, 5, 13, 8, 14),
								'name': '170W_core'}],
		...
		self.SN4 = {'sample_name': 'SN4',
					...
					'moisture_columns': ['MS1', 'MS2', 'MS3', 'MS4', 'MS5', 'MS6',
										 'MS7', 'MS8', 'MS9', 'MS10', 'MS11', 'MS12'],
					'power_column': ['power'],
					'timestamps': [[pd.Timestamp(2021, 5, 18, 12, 57), '230W core'],
								   [pd.Timestamp(2021, 5, 15, 13, 00), '320W core']],									# not final
					'phases': [{'start': pd.Timestamp(2021, 5, 15, 11, 15), 'end': pd.Timestamp(2021, 5, 18, 12, 57),
								'name': '230W_core'},
							   {'start': pd.Timestamp(2021, 5, 18, 12, 58), 'end': pd.Timestamp(2021, 5, 15, 13, 00),	# not final
								'name': '320W_core'}],
					'hot_end_sensors': {'sensors': ['C1', 'C2'],
										'locations': [0.1]},
					'cold_end_sensors': {'sensors': ['W1', 'W2'],
